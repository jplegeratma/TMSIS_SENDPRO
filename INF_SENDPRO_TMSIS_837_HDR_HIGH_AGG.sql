...
select RUN_DATE, MCO, Types, PRIORITY, MEASURE, Criteria, CASE WHEN SUM_ALL_REC_CNT = 0 THEN 0 ELSE SUM_VALID_REC_CNT/SUM_ALL_REC_CNT END AS PCT_VALID 
from (
...
from (
---
select RUN_DATE, MCO, CASE WHEN SUM_ALL_REC_CNT = 0 THEN 0 ELSE SUM_VALID_REC_CNT/SUM_ALL_REC_CNT END AS PCT_VALID,
from (
