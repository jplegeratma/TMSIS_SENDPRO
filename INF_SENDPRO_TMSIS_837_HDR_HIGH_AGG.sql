...
select RUN_DATE, MCO, Types, PRIORITY, MEASURE, Criteria, SUM_VALID_REC_CNT/SUM_ALL_REC_CNT AS PCT_VALID 
from (
...
CASE WHEN TYPE IN ('VALID','NOT APP') THEN REC_CNT ELSE 0 END AS VALID_REC_CNT,
REC_CNT AS ALL_REC_CNT
...
from (
---
select RUN_DATE, MCO, SUM_VALID_REC_CNT/SUM_ALL_REC_CNT AS PCT_VALID,
from (
...
select
TO_DATE('20250930','YYYYMMDD') AS CURRENT_DATE,
MCO, 
