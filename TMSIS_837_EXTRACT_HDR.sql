...
select DISTINCT
TO_DATE('20250930','YYYYMMDD') AS RUN_DATE,
...
and date(inst.DOS_FROM_DT) BETWEEN TO_DATE('20250901','YYYYMMDD')
          AND TO_DATE('20250930','YYYYMMDD')
...
and date(prof.DOS_FROM_DT) BETWEEN TO_DATE('20250901','YYYYMMDD')
          AND TO_DATE('20250930','YYYYMMDD')
UNION
...
and date(dntl.DOS_FROM_DT) BETWEEN TO_DATE('20250901','YYYYMMDD')
          AND TO_DATE('20250930','YYYYMMDD')
...
and date(phrm.DOS_FROM_DT) BETWEEN TO_DATE('20250901','YYYYMMDD')
          AND TO_DATE('20250930','YYYYMMDD')
;
*/
--  );
