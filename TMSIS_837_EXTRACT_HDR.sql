...
select DISTINCT
TO_DATE('20251231','YYYYMMDD') AS RUN_DATE,
...
and date(inst.DOS_FROM_DT) BETWEEN TO_DATE('20250101','YYYYMMDD')
...
and date(prof.DOS_FROM_DT) BETWEEN TO_DATE('20250101','YYYYMMDD')
          AND TO_DATE('20251231','YYYYMMDD')
UNION
...
and date(dntl.DOS_FROM_DT) BETWEEN TO_DATE('20250101','YYYYMMDD')
          AND TO_DATE('20251231','YYYYMMDD')
...
and date(phrm.DOS_FROM_DT) BETWEEN TO_DATE('20251001','YYYYMMDD')
          AND TO_DATE('20251231','YYYYMMDD')
;
*/
--  );
